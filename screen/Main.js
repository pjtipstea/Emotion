...
export default class Main extends Component {
    ...
    createList(i) {
      if (this.state.wordSpace[i] != '' || this.state.stateSpace[i] != '') {
        console.log("\n");
        ...
        if (count <= 5) {
          ...
          index = this.state.emotion.find((element)=> {
            if (element.word === this.state.wordSpace[i]) {
              element.frequency = -1;
              return element;
            }
          })
          ...
          index = this.state.state.find((element)=> {
            if (element.word === this.state.stateSpace[i]) {
              element.frequency = -1;
              return element;
            }
          })
        ...
        var V = (this.state.V * (count - 1) + index.V) / count;
        var A = (this.state.A * (count - 1) + index.A) / count;
        var D = (this.state.D * (count - 1) + index.D) / count;
        ...
        tmp.map((item) => {
          ...
          console.log(item.word + " result : " + item.result + " fre : " + item.frequency);
        })
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
              {this.state.count < 5 ?
                <View style={{flex:1}}>
                  <View style={styles.wordTopBottom}>
                    <View style={styles.wordCol}>
                      <View style={styles.wordSpace}>
                        {this.state.count >= 1 ?
                          <Text style={styles.word}>{this.state.selected[0].word}</Text>
                          :
                          <Text style={styles.wordBlank}/>
                        }
                      </View>
                      <View style={styles.wordSpace}>
                        {this.state.count >= 2 ?
                          <Text style={styles.word}>{this.state.selected[1].word}</Text>
                          :
                          <Text style={styles.wordBlank}/>
                        }
                      </View>
                      <View style={styles.wordSpace}>
                        {this.state.count >= 3 ?
                          <Text style={styles.word}>{this.state.selected[2].word}</Text>
                        :
                        <Text style={styles.wordBlank}/>
                        }
                      </View>
                      <View style={styles.wordSpace}>
                        {this.state.count >= 4 ?
                          <Text style={styles.word}>{this.state.selected[3].word}</Text>
                        :
                        <Text style={styles.wordBlank}/>
                        }
                      </View>
                      <View style={styles.wordSpace}>
                        {this.state.count >= 5 ?
                          <Text style={styles.word}>{this.state.selected[4].word}</Text>
                        :
                        <Text style={styles.wordBlank}/>
                        }
                      </View>
                ...
                <View style={{flex:1}}>
                  ...
                  <View style={styles.wordBody}>
                    <View style={styles.wordCol}>
                      <TouchableOpacity onPress={() => this.createList(8)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[8]}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity onPress={() => this.createList(9)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[9]}</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={styles.wordCol}>
                      <TouchableOpacity onPress={() => this.createList(4)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[4]}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity onPress={() => this.createList(5)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[5]}</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={styles.wordCol}>
                      <TouchableOpacity onPress={() => this.createList(0)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[0]}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity onPress={() => this.createList(1)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[1]}</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={styles.wordCol}>
                      <TouchableOpacity onPress={() => this.createList(2)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[2]}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity onPress={() => this.createList(3)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[3]}</Text>
                      </TouchableOpacity>
                    </View>
                    <View style={styles.wordCol}>
                      <TouchableOpacity onPress={() => this.createList(6)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[6]}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity onPress={() => this.createList(7)} style={styles.wordSpace}>
                        <Text style={styles.word}>{this.state.stateSpace[7]}</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  <View style={styles.wordTopBottom}>
                    <View style={styles.wordCol}>
                      <View style={styles.wordSpace}>
                        {this.state.count >= 6 ?
                          <Text style={styles.word}>{this.state.selected[5].word}</Text>
                        :
                          <Text style={styles.wordBlank}/>
                        }
                      </View>
                      <View style={styles.wordSpace}>
                      {this.state.count >= 7 ?
                          <Text style={styles.word}>{this.state.selected[6].word}</Text>
                        :
                          <Text style={styles.wordBlank}/>
                        }
                      </View>
